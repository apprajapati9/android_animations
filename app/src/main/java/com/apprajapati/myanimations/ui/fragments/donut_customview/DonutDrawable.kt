package com.apprajapati.myanimations.ui.fragments.donut_customview
...
class DonutDrawable(sprinkleCount: Int) : Drawable() {
    ...
    @get:Keep
    @set:Keep var sprinkleRotation = 0f
        set(value) {
            field = value
            invalidateSelf()
        }
...
//https://www.youtube.com/watch?v=H05mF0qrBVA - from this droidcon talk tutorial